...
as per the sample application, i.e. Video Search and Summarization, [documentation](../../../../../sample-applications/video-search-and-summarization/docs/user-guide/get-started/system-requirements.md).
