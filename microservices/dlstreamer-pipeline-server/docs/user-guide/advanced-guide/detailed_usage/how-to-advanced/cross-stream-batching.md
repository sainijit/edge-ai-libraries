...
configuration, but the performance is expected to be similar to [DL Streamer](https://github.com/open-edge-platform/dlstreamer/blob/main/docs/user-guide/dev_guide/performance_guide.md#3-multi-stream-pipelines-with-single-ai-stage).
